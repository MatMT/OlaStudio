      ...
      <main className="flex-1 bg-background min-h-screen pt-12 pb-24">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="aspect-square bg-muted/10 rounded-3xl flex items-center justify-center p-8 border border-border/50">
              <div className="w-full h-full bg-gradient-to-tr from-muted/20 to-muted/40 rounded-full animate-pulse" />
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-8 border-t border-border/50">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted">Puntas de alta calidad diseñadas para funcionar a la perfección.</p>
                  </div>
                </div>
              </div>
